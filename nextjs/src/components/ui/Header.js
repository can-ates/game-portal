...
function Header() {
	...
	const renderMenu = (
		...
		>
			{({ TransitionProps, placement }) => (
				...
				>
					<Paper
						style={{ backgroundColor: theme.palette.green.light }}
					>
	...
	const handleSearch = e => {
		...
		axios
			.get(
				`https://api.rawg.io/api/games?search=${search}&page_size=5&key=${process.env.NEXT_PUBLIC_RAWG_KEY}`,
				{
